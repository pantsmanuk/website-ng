...
<td width="25" align="center"><a href="<?php echo $base_url.'acp_propilot/event_edit/0'; ?>"><img src="<?php echo $image_url; ?>icons/application/database_add.png" alt="Add" /></a></td>
