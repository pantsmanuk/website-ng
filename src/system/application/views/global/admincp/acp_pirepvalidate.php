...
<table border="0">
<tr>  
<td width="25" align="center"><img src="<?php echo $image_url; ?>icons/application/application_view_detail.png" alt="View Flights" /></td>
<td align="left">View Flights</td>
<td width="25" align="center"><img src="<?php echo $image_url; ?>icons/application/database_error.png" alt="Query" /></td>
<td align="left">Query</td>
<td width="25" align="center"><img src="<?php echo $image_url; ?>icons/application/database_add.png" alt="Approve" /></td>
<td align="left">Approve</td>
<td width="25" align="center"><img src="<?php echo $image_url; ?>icons/application/database_edit.png" alt="Delete" /></td>
