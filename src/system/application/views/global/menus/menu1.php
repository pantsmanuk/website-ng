<ul class="menu5">
	...
	<ul>
        ...
        <li class="divisions"><a href="<?php echo $base_url; ?>divisions/">Divisions<!--[if IE 7]><!--></a><!--<![endif]-->
        <!--[if lte IE 6]><table><tr><td><![endif]-->
        <ul>
        ...
        <li class="missions"><a href="<?php echo $base_url; ?>missions/">Missions<!--[if IE 7]><!--></a><!--<![endif]-->
        <!--[if lte IE 6]><table><tr><td><![endif]-->
        <ul>
