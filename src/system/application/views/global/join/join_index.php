...
<div class="container">
    ...
    <tr>
    <td></td>
    <td><font color="#777777">I have read and agree to the Rules and Regulations of the VA and understand the standard operating procedures of the airline</font></td>
    </tr>
    <tr>
    <td><img src="<?php echo $image_url; ?>icons/application/accept.png" alt="tick" /></td>
    ...
    <tr>
    <td></td>
    <td><font color="#777777">I have downloaded and installed the training aircraft to perform my first flight</font></td>
    </tr>
    <tr>
    <td><img src="<?php echo $image_url; ?>icons/application/accept.png" alt="tick" /></td>
    ...
    <tr>
    <td></td>
    <td><font color="#777777">I have downloaded and installed the Flight logging software to automatically record and approve my flights <b>after</b> I have posted my first flight here</font></td>
    </tr>
    </table>
...
<div class="container">
    ...
    <b>ILS landing</b>
    <br />
    Similar to the previous flights, fly a circuit around the airport using the autopilot to execute heading and altitude holds. Expand the distance flown from the airfield, but fly longer on the parallel stretch, so that it is possible to make a 135 degree turn to intercept the runway line at 45 degrees. Ensure that the interecept is at least 4 runway lengths from the runway threshold.<br />
    <br />
