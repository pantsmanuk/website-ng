...
<script type="text/javascript" src="<?php echo $assets_url.'javascript/functions/jquery-1.10.2.min.js'; ?>"></script>
...
<script type="text/javascript" src="<?php echo $assets_url.'javascript/functions/scriptaculous.js?load=effects,builder.js'; ?>"></script>
<script type="text/javascript" src="<?php echo $assets_url.'javascript/functions/lightbox-2.6.min.js'; ?>"></script>
