...
class Pirep_model extends CI_Model{
	...
	function tour_award($pilot_id = '', $tour_id = '', $award_id = '', $gmt_mysql_datetime){
						...
						//assign tour award
							...
							if($num_results < 1){
								...
								$award_data = array(
										...
										'assigned_date' => $gmt_mysql_datetime,
								);
	...
	function event_award($pilot_id = '', $event_id = '', $award_id = '', $gmt_mysql_datetime){
