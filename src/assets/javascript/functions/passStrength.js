...
function checkPassword(password) { 
    ...
    // work out how long it would take to crack this (@ 2000 attempts per second) 
    var timeInSeconds = (totalCombinations / 2000) / 2; 
    ...
    progressBar.style.width = (friendlyPercentage-1) + "%"; 
...
function checkSame(){
	...
	var suppliedPass1 = document.getElementById('newpassword1').value;
	var suppliedPass2 = document.getElementById('newpassword2').value;
	
	if(suppliedPass1 == suppliedPass2){
		document.getElementById('credmatch').innerHTML = "New Passwords Match";
		document.getElementById('credmatch').style.backgroundColor = "green"; 
	}
	else{
		document.getElementById('credmatch').innerHTML = "New Passwords do not match";
