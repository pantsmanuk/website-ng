...
<div align="center">
    ...
    <table class="statbox" width="400">
        ...
        <tr>
			...
			?>
            <td width="250">
                <div align="right">New Email:</div>
            </td>
            <td width="150">
                <div align="left"><?php echo form_input($checkfield1, '', $js); ?></div>
            </td>
        ...
        <tr>
            ...
            <td width="250">
                <div align="right">New Email (again):</div>
            </td>
            <td width="150">
                <div align="left"><?php echo form_input($checkfield2, '', $js); ?></div>
            </td>

        </tr>
        <tr>
            <td colspan="2" align="center">
                <div id="credmatch" style="background: green; font-weight: bold; color: #FFF; line-height: 20px;">Email
                    Addresses Match
                </div>
            </td>
        </tr>
