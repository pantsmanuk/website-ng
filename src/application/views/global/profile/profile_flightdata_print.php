...
<table width="850" border="1" bordercolor="3962c1" style="border-collapse: collapse; border: 1px dashed #000000;"
       cellspacing="0">
    <tr>
    ...
    <tr>
        ...
        <td width="213"><strong><font size="2" face="Courier New, Courier, mono">Great Circle Distance</font></strong>
        </td>
    ...
    <tr>
        <td width="212" height="23"><font size="2"
                                          face="Courier New, Courier, mono"><?php echo $engine_start_time; ?></font>
        </td>
    ...
    <tr>
        <td width="212" height="23"><font size="2" face="Courier New, Courier, mono"><?php echo $cruisealt; ?></font>
        </td>
    ...
    <tr>
        <td width="212" height="23"><font size="2" face="Courier New, Courier, mono"><strong>Comments</strong></font>
        </td>
        <td width="213">&nbsp;</td>
    ...
    <tr>
        <td height="23" colspan="4"><font size="2" face="Courier New, Courier, mono"><?php echo $comments; ?></font>
        </td>
    </tr>
</table>
</body>
