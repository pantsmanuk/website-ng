...
?>
<td width="250"><div align="right">New Password:</div></td> <td width="150"><div align="left"><?php echo form_password($newpassword1, '', $js); ?></div></td>

</tr><tr>

<td width="250"><div align="right">New Password (again):</div></td> <td width="150"><div align="left"><?php echo form_password($newpassword2, '', $js); ?></div></td>

</tr><tr>
<td colspan="2" align="center">
<div id="credmatch" style="background: green; font-weight: bold; color: #FFF; line-height: 20px;">New Passwords Match</div>
</td>
</tr>

<tr>
<td width="250"><div align="right">Password Strength:</div></td><td width="150">
