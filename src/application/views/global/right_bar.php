<div class="rightbar">
    ...
    <div style="margin-left: 5px; margin-right: 5px;">
        ...
        <br/><a href="<?php echo $base_url_minimal; ?>assets/files/manuals/ehm_online_manual.pdf">Online Flying
            Manual</a>
        <br/><a href="<?php echo $base_url_minimal; ?>assets/files/manuals/NG_Website_User_Guide.pdf">NG Website
            Manual</a>
	...
	if (isset($sim_stats)) {
		...
		foreach ($sim_stats as $row) {
			...
			if (!array_key_exists($row->version_name, $sim_array)) {
				$sim_array[$row->version_name] = 0;
			}
    ...
    <div style="margin-left: 5px; margin-right: 5px;">
        ...
        <a href="<?php echo $base_url . 'information/latest_flights/'; ?>"><img
                    src="<?php echo $image_url; ?>content/partners/latest_flights.jpg" alt="Latest Flights"/></a>
        <br/><br/>
    </div>
    ...
    <div style="margin-left: 5px; margin-right: 5px;">
        ...
        <a href="<?php echo $base_url . 'information/online/'; ?>"><img
                    src="<?php echo $image_url; ?>content/partners/ivao_logo_sm.png" alt="IVAO"/></a>
        <br/><br/>
        <a href="<?php echo $base_url . 'information/online/'; ?>"><img
                    src="<?php echo $image_url; ?>content/partners/vatsim_logo_sm.png" alt="VATSIM"/></a>
        <br/><br/>
        <hr/>
        <br/>
        <a href="<?php echo $base_url . 'information/discounts/'; ?>"><img
                    src="<?php echo $image_url; ?>content/partners/aerosoft.png" alt="Aerosoft"/></a>
        <br/><br/>
        <a href="<?php echo $base_url . 'information/discounts/'; ?>"><img
                    src="<?php echo $image_url; ?>content/partners/fs2crew.png" alt="FS2Crew"/></a>
        <br/><br/>
        <a href="<?php echo $base_url . 'information/discounts/'; ?>"><img
                    src="<?php echo $image_url; ?>content/partners/oryxsim.png" alt="Oryxsim"/></a>
        <br/><br/>
