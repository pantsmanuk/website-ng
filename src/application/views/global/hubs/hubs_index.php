                ...
                <table>
                    <tr valign="top">
                        <td>
                            ...
                            <img src="<?php echo $tmpl_image_url; ?>structure/hubs/hub_<?php echo strtolower($selected_hub_icao); ?>.jpg"
                                 alt="<?php echo $selected_hub_icao; ?> hub"
                                 style="float: left; padding: 3px; margin-right: 3px; border: #bbbbbb 1px solid;"/>
