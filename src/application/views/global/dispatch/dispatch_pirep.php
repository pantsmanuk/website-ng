...
<br/><br/>
<div style="color: #777777;">Manual submissions have to be approved before showing up in your flight log. Flight Logger
    can automatically record, submit and approve both normal and propilot flights. <a
            href="<?php echo $flogger_latest; ?>">Download Flogger <?php echo $flogger_version; ?> Now.</a></div>
<br/>
