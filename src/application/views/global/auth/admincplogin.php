...
<div align="center">
    ...
    As an additional security check, you are required to reauthenticate to access the admin control panel. You will need
    to reauthenticate each time you do not access admin functions for more than 15 minutes.
