...
<div>
In order to better support multiple flight-simulators and allow you more simming enjoyment, we operate a relaxed policy on our aircraft types. <br /><br />This means that while the official fleet aircraft and supporting files are listed, you may fly a close variant aircraft. E.G. An MD-81 or MD-82 may be flown as a substitute for the MD-83, an Airbus A300F instead of the A310-300F, a 747-200 instead of the 747-400 and a CRJ-200 instead of the Challenger 850. <br /><br />Substantially different types may not be flown as a substitute. A Sequioa Falco may not be flown in place of a Cessna, and a 727-200 may not be flown in place of an MD-11.
</div>
