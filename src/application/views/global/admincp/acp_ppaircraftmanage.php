...
<td width="25" align="center"><a href="<?php echo $base_url; ?>acp_propilot/aircraft_edit/0"><img src="<?php echo $image_url; ?>icons/application/database_add.png" alt="Add" /></a></td>
<td align="left"><a href="<?php echo $base_url; ?>acp_propilot/aircraft_edit/0">Add New</a></td>
</tr>
</table>     
...
<?php
$hidden['valid'] = 'true';
echo form_open('acp_propilot/aircraft_manage/'.$aircraft_restrict.'/'.$location_restrict.'/'.$status_restrict.'/'.$acstatus_restrict.'/', '', $hidden);
...
<div align="right">
<?php
echo form_open('acp_propilot/aircraft_manage/'.$aircraft_restrict.'/'.$location_restrict.'/'.$status_restrict.'/'.$acstatus_restrict.'/'.$search_url, '', $hidden);
...
<th width="100">Pilot</th>
<th width="70">Last Flown</th>
