...
<center>
    <table border="0">
        <tr>
            ...
            <td width="25" align="center"><a href="<?php echo $base_url . 'acp_timetables/edit/0'; ?>"><img
...
//add all to the csv dump
		...
		?>
        <tr>
            <td colspan="12"><span style="float: right;"><p><?php echo $this->pagination->create_links(); ?></p></span>
            </td>
        </tr>
    </table>
