        ...
        <table border="0">
            <tr>
                <td width="25" align="center"><a
                            href="<?php echo $base_url . 'acp_propilot/event_legs_edit/' . $event_id . '/0/' . $i . '/'; ?>"><img
                                src="<?php echo $image_url; ?>icons/application/database_add.png" alt="Add"/></a></td>
                <td align="left"><a
                            href="<?php echo $base_url . 'acp_propilot/event_legs_edit/' . $event_id . '/0/' . $i . '/'; ?>">Add
                        new</a></td>

                <td width="25"></td>

                <td width="25" align="center"><a
                            href="<?php echo $base_url . 'acp_propilot/event_awards_remark/' . $event_id . '/'; ?>"><img
                                src="<?php echo $image_url; ?>icons/application/award_star_gold_1.png" alt="Add"/></a>
                </td>
                <td align="left"><a
                            href="<?php echo $base_url . 'acp_propilot/event_awards_remark/' . $event_id . '/'; ?>">Remark
                        Awards</a></td>
            </tr>
        </table>
