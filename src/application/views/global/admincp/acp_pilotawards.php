...
<td width="25" align="center"><a href="<?php echo $base_url.'acp_pilots/award_edit/'.$pilot_id.'/0/'; ?>"><img src="<?php echo $image_url; ?>icons/application/database_add.png" alt="Add" /></a></td>
<td align="left"><a href="<?php echo $base_url.'acp_pilots/award_edit/'.$pilot_id.'/0/'; ?>">Assign New</a></td>
</tr>
</table> 
