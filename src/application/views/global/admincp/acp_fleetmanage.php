...
<center>
    <table border="0">
        <tr>
            ...
            <td width="25" align="center"><img src="<?php echo $image_url; ?>icons/application/database_save.png"
                                               alt="Downloads"/></td>
            <td align="left">Downloads</td>
            <td width="25" align="center"><a href="<?php echo $base_url . 'acp_fleet/edit/0'; ?>"><img
