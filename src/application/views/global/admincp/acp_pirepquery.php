...
<img src="<?php echo $image_url; ?>icons/application/pencil.png" alt="edit" style="vertical-align:middle;" /> Edit Pirep</a>
</div>
...
<br />
<center>
<img src="http://www.gcmap.com/map?P=<?php echo $start_icao.'-'.$end_icao;?>&MS=bm&MX=720x180&PM=*" alt="Pirep: <?php echo $start_icao.'-'.$end_icao;?>" />
</center>
