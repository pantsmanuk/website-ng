                    ...
                    <table border="0">
                        <tr>
                            <td width="25" align="center"><img
                                        src="<?php echo $image_url; ?>icons/application/database_edit.png" alt="Edit"/>
                            </td>
                            <td align="left">Edit</td>
                            <td width="25" align="center"><a
                                        href="<?php echo $base_url . 'acp_fleet/downloads_edit/' . $aircraft_id . '/0/'; ?>"><img
                                            src="<?php echo $image_url; ?>icons/application/database_add.png"
                                            alt="Add"/></a></td>
                            <td align="left"><a
                                        href="<?php echo $base_url . 'acp_fleet/downloads_edit/' . $aircraft_id . '/0/'; ?>">Add
                                    New</a></td>
                        </tr>
                    </table>
                </center>
