        ...
        <table border="0">
            <tr>
                <td width="25" align="center"><a
                            href="<?php echo $base_url . 'acp_tours/legs_edit/' . $tour_id . '/0/' . $i . '/' . $selected_version; ?>"><img
                                src="<?php echo $image_url; ?>icons/application/database_add.png" alt="Add"/></a></td>
                <td align="left"><a
                            href="<?php echo $base_url . 'acp_tours/legs_edit/' . $tour_id . '/0/' . $i . '/' . $selected_version; ?>">Add
                        new</a></td>
            </tr>
        </table>
