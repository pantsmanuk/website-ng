...
|--------------------------------------------------------------------------
|
| The host filesystem path that contains your CodeIgniter install, WITH a
| trailing slash.
|
...
|
*/
$config['encryption_key'] = 'vI8WgA38fVzKIYLpaaeInZJIiWqEP6hQ';
...
$config['sess_cookie_name'] = 'ehm_sessions';
$config['sess_expiration'] = 21600;
$config['sess_save_path'] = 'ehm_sessions';
